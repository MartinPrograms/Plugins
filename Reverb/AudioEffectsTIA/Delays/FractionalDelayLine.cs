...
public class FractionalDelayLine
{
    ...
    public FractionalDelayLine(int delay, double gain, double fractionalDelay, bool writeFeedback = true, bool readFeedback = true, int buffSize = 1)
    {
   ...
   public double ProcessSample(double sample)
   {
       ...
       double output = AudioSample.Mix(_buffer[(int)readIndex], _buffer[(int)Mod(readIndex + 1, _buffer.Length)], frac);
